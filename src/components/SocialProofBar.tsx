...
export default function SocialProofBar() {
  ...
  return (
    <section className="relative bg-white py-4 md:py-6 border-b border-gray-100 -mt-1 z-10">
      <div
        ref={ref}
      ...
      >
        ...
        <div className="flex flex-col items-center gap-3 md:hidden">
          <div className="flex items-center gap-4">
            {platforms.map((platform) => (
              <div key={platform.naam} className="flex items-center gap-1.5">
                ...
                <span className="text-xs">
                  ...
                  <span className="text-gray-400"> {platform.naam}</span>
                </span>
              </div>
            ))}
          </div>
        ...
        <div className="hidden md:flex items-center justify-center gap-12">
          ...
          <div className="flex items-center gap-2 text-sm text-gray-500">
            <svg className="h-5 w-5 text-green-500 shrink-0" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
              <path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z" />
              <polyline points="9 12 12 15 16 10" />
            </svg>
            <span>Geen voorrijkosten &bull; Garantie op werk</span>
